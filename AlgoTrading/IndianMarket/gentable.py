...
def gen():
    df1 = pd.read_csv (r'/home/keshav/Desktop/Prices/today.csv')
    df1 = df1.loc[:, 'SYMBOL':'CLOSE']


    df2 = pd.read_csv (r'/home/keshav/Desktop/Prices/week.csv')
    df2 = df2.loc[:, 'SYMBOL':'CLOSE']

    df3 = pd.read_csv (r'/home/keshav/Desktop/Prices/month.csv')
    df3 = df3.loc[:, 'SYMBOL':'CLOSE']

    df4 = pd.read_csv (r'/home/keshav/Desktop/Prices/threemonth.csv')
    df4 = df4.loc[:, 'SYMBOL':'CLOSE']

    df5 = pd.read_csv (r'/home/keshav/Desktop/Prices/sixmonth.csv')
    df5 = df5.loc[:, 'SYMBOL':'CLOSE']

    df6 = pd.read_csv (r'/home/keshav/Desktop/Prices/year.csv')
